...
if "ans_val" not in st.session_state:
    st.session_state.ans_val = ""
...
def new_question():
    ...
    st.session_state.num2 = random.randint(1, 50)
    st.session_state.op = random.choice(["+", "-"])
    st.session_state.ans_val = ""  # เคลียร์ค่าช่องตอบ
...
answer = st.text_input("กรอกคำตอบ:", value=st.session_state.ans_val, key="ans_val")
